...
# Set BOT_DATA_DIR=/data/bot_data when a Railway Volume is mounted at /data.
# Falls back to a local directory for normal/local runs.
DATA_DIR = os.environ.get("BOT_DATA_DIR") or ("/data/bot_data" if os.path.isdir("/data") else "bot_data")
